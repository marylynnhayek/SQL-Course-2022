-- Code #7: Révision pour l’examen final:
--Table 1
...
--Table 2: Select code to execute alone if the code above has already been executed, or place previously executed code between /* ... */
create table Course(
